...
#setwd("data/Boxplotdata/")
library(here)

z= read.csv(here::here('data/Boxplotdata/TrackPointSept1st12AM_AOITweet.csv'), header = T)
head(z)
str(z)
...
z1= read.csv(here::here('data/Boxplotdata/TrackPointSept6th12PM_AOITweet.csv'), header = T)
head(z1)
str(z1)
...
z2= read.csv(here::here('data/Boxplotdata/TrackPointSept1st12AM_US_GdeltJoin.csv'), header = T)
head(z2)
str(z2)
...
z3= read.csv(here::here('data/Boxplotdata/TrackPointSept6th12PM_US_Gdeltjoin.csv'), header = T)
head(z3)
str(z3)
...
png(filename = here("results/Fig 3.png"), width = 880, height = 620)
par(mfrow=c(2,2))
