...
t <- read.csv(here::here('data/Correlationdata/Tweets_Gdeltcordatawithout0.csv'), header = T)
...
r= read.csv(here::here('data/Correlationdata/Tweets_Gdeltcordatawithout0.csv'), header = T)
head(r)
#pairs(r)

png(here::here("results/Fig 6.png"), width = 646, height = 656)
